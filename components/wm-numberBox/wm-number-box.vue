<template>
	<view>
		<view class="wm-numbox">
			<view :class="['wm-numbox_btn1 flexs',model==2?'wm-numbox_radio_m':'wm-numbox_minus',inputValue <= min?'numbox_disabled':'']" :style="{width:30+'px',height:height+'px',lineHeight:height-6+'px',fontSize:height-3+'px'}" @click="Minus">-</view>
			<input :class="['wm-numbox_value',model==2?'':'wm-numbox_bg']" type="number" :disabled="disabled" :style="{width:height/0.8+'px',height:height+'px',fontSize:14+'px'}" value="0" v-model="inputValue" @blur="BoxOnBlur"/>
			<view :class="['wm-numbox_btn flexs',model==2?'wm-numbox_radio_p':'wm-numbox_plus',inputValue >= max?'numbox_disabled':'']" hover-class="Number_hover" :style="{width:30+'px',height:height+'px',lineHeight:height-6+'px',fontSize:height-5+'px'}" @click="Plus">+</view>
		</view>
		<view class="wn-good-box" v-show="conShop" :style="{left: com_x+'px',top: com_y+'px',width:30+'px',height:height+'px',opacity:opacity}">
...
.wm-numbox{
	...
	position: relative;
		...
		.wm-numbox_btn1{
			margin: 0;
			padding: 0;
			border:2rpx solid #D2D2D2 ! important;
			text-align: center;
