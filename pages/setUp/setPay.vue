<template>
	<view class='content'>
		<view class="top">
			<view class='list  flexs3'>
				...
				<view class="list_input flexs1">
					<input class="uni-input" type="text" password placeholder="请输入支付密码" v-model="password" />
				</view>
			</view>
			<view class='list  flexs3'>
				<image src="../../static/image/possword_icon_possword@2x.png"></image>
		...
		<view class="btns flexs">
			<image src='../../static/image/btn_wancheng@2x.png' @click="setPayPass"></image>
		</view>
	</view>
</template>
	...
	export default {
		...
		methods: {
			setPayPass() {
				...
				this.$common.requests('/api/login/setPayPass', obj).then(res => {
